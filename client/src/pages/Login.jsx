    ...
    <div className="flex items-center justify-center min-h-screen bg-animated-gradient">
      <div className="p-10 glass-panel rounded-2xl w-[400px] animate-fadeIn">
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 bg-indigo-500/20 rounded-full flex items-center justify-center mb-4 border border-indigo-500/30 shadow-[0_0_15px_rgba(99,102,241,0.5)]">
            <LogIn className="w-8 h-8 text-indigo-400" />
          </div>
          <h2 className="text-3xl font-bold text-white tracking-wide">Welcome Back</h2>
          <p className="text-gray-400 mt-2">Login to your CodeSync account</p>
        </div>
        ...
        <p className="mt-8 text-center text-gray-400 animate-fadeIn animate-delay-300">
          Don't have an account? <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 hover:underline transition font-medium">Create one</Link>
        </p>
      </div>
    </div>
  );
